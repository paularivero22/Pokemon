    ...
    return new Promise((resolve, reject) => {
        ...
        worker.onmessage = function (event) {
            ...
            equipo1Datos.forEach(pokemonWorker => {
                const stats = {
                    hp: pokemonWorker.stats.find(stat => stat.stat.name === "hp")?.base_stat || 0,
                    attack: pokemonWorker.stats.find(stat => stat.stat.name === "attack")?.base_stat || 0,
                    defense: pokemonWorker.stats.find(stat => stat.stat.name === "defense")?.base_stat || 0,
                    speed: pokemonWorker.stats.find(stat => stat.stat.name === "speed")?.base_stat || 0,
                };
